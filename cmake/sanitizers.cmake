...
option(BUILD_THSAN "Build with ThreadSanitizer to detect data race issues" OFF)

set(COUNTER 0)
set(ALL_OPTIONS BUILD_ASAN;BUILD_MSAN;BUILD_THSAN)
...
if(BUILD_THSAN)
    message("-- ThreadSanitizer WILL be compiled in as BUILD_THSAN=ON")
    add_compile_options(-fsanitize=thread -g)
    add_link_options(-fsanitize=thread)
    set(SANITIZER_NAME "ThreadSanitizer")
    add_definitions(-DSANITIZER_NAME="${SANITIZER_NAME}")
else()
    message("-- ThreadSanitizer will NOT be compiled in as BUILD_THSAN=OFF")
endif()