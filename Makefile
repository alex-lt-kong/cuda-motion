main: ./src/main.cpp deviceManager.o motionDetector.o logger.o
	g++ ./src/main.cpp deviceManager.o motionDetector.o logger.o -o motionDetector.out -I/usr/local/include/opencv4 -L/usr/local/lib -lopencv_highgui -lopencv_imgcodecs -lopencv_video -lopencv_videoio -lopencv_imgproc -lopencv_core -pthread  -O3
