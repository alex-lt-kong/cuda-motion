...
auto steady_clock_to_system_time(std::chrono::time_point<std::chrono::steady_clock, Duration> steady_tp) {
  ...
  return system_clock::time_point(duration_cast<system_clock::duration>(steady_tp.time_since_epoch() + drift));
}
